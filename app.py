...
class CodeCareGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("CodeCare AI - Medical Coding Assistant")
        self.root.geometry("1100x750")  # Increased window size
        self.root.configure(bg="#f0f4f8")
        
        # Set app icon if available
        try:
            icon_path = "codecare_icon.ico"
    ...
    def create_header(self):
        ...
        # App title
        title_label = tk.Label(header_frame, text="CodeCare AI", font=('Segoe UI', 18, 'bold'), bg="#f0f4f8", fg="#1e293b")
